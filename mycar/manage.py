    ...
    class DriveMode:
         def run(self, mode, user_angle, user_throttle, pilot_angle, pilot_throttle):
             ...
             if mode == 'user':
                 ...
                 cam = PiCamera()
                 data1 = np.loadtxt("/home/pi/projects/donkeycar/donkeycar/parts/data.txt")
                 ...
                 if area<20000 and area!=0:
                     if seat[0][0]<1500:
                         ...
                         user_angle=-0.05
                         user_throttle=-0.75
                     elif seat[0][0]>=1500 or seat[0][0]<=1650:
                         user_angle=0
                         user_throttle=-0.75
                 elif area>=20000 or area<=30000:
                     if seat[0][0]<1300:
                         user_angle=0
                         user_throttle=0
                     elif seat[0][0]>1400:
                         user_angle=0
                         user_throttle=0
                     elif seat[0][0]>=1300 or seat[0][0]<=1400:
                         user_angle=0
                         user_throttle=0
                 if area>30000:
                     if seat[0][0]<1550:
                         ...
                         user_angle=0.15
                         user_throttle=0.5
                     elif seat[0][0]>=1550 or seat[0][0]<=1650:
                         user_angle=0
                         user_throttle=0.5
                 elif area==0:
                     user_angle=0
                 ...
                 print('user_throttle',user_throttle)
